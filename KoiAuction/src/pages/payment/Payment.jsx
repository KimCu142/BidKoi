...
function Payment({ auctionAmount }) {
  ...
  const handleDeposit = async () => {
    try {
      ...
      const vnpaySandboxUrl = `https://sandbox.vnpayment.vn/paymentv2/vpcpay.html?vnp_Amount=${
        paymentAmount * 100
      }&vnp_TmnCode=2QXUI4J4&vnp_TxnRef=${Date.now()}&vnp_OrderInfo=Test+Payment&vnp_ReturnUrl=http://localhost:5173/payment-success&vnp_Version=2.1.0&vnp_Command=pay&vnp_CurrCode=VND&vnp_Locale=vn`;
